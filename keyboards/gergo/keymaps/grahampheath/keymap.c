...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* ├─────────────┼────────┼────────┼────────┼────────┼────────┼────────┐                         ┌────────┼────────┼────────┼────────┼────────┼────────┼─────────────┤ */
  /* │             │   <--  │   F3   │        │   ↑    │        │ F12    │                         │        │        │    -   │    =   │    {   │    }   │     |       │ */
      _______,      KC_BACK, KC_F3,   _______,  KC_UP,   _______,  KC_F12,                            _______, _______, KC_MINS,  KC_EQL, KC_LCBR, KC_RCBR, KC_PIPE,
  /* ├─────────────┼────────┼────────┼────────┼────────┼────────┼────────┤┌────────┐     ┌────────┐├────────┼────────┼────────┼────────┼────────┼────────┼─────────────┤ */
  /* │             │        │        │        │   ↓    │        │ F11    ││        │     │        ││   ⏮    │       │    _   │   +    │   [    │    ]   │             │ */
      _______,      _______, _______, _______,  KC_DOWN, _______,  KC_F11,   _______,       _______,  KC_MPRV, _______, KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, _______,
  /* └─────────────┴────────┴────────┴────────┴────────┴────────┴────────┘└────────┘     └────────┘└────────┴────────┴────────┴────────┴────────┴────────┴─────────────┘ */
  /*                                                             /────────/────────/      \────────\────────\   */
  /*                                  ┌────────┬──────────┐     /        /        /        \        \        \   ┌───────────┬────────┐ */
  /*                                  |        |          |    /        /        /          \        \        \  |           |        | */
  ...
  [_RAISE] = LAYOUT_gergo(
    ...
    /* ├─────────────┼────────┼────────┼────────┼────────┼────────┼────────┐                         ┌────────┼────────┼────────┼────────┼────────┼────────┼─────────────┤ */
    /* │             │   F 1  │   F2   │   F3   │   F4   │   F5   │   F6   │                         │        │   ←    │    ↓   │   ↑    │    →   │        │      \      │ */
        _______,      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                             _______, KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT,  _______, KC_BSLS,
    /* ├─────────────┼────────┼────────┼────────┼────────┼────────┼────────┤┌────────┐     ┌────────┐├────────┼────────┼────────┼────────┼────────┼────────┼─────────────┤ */
    /* │             │   F7   │   F8   │   F9   │  F10   │   F11  │     12 ││        │     │        ││   ⏭   │    [   │   ]    │        │         │        │             │ */
        _______,      KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   _______,       _______,  KC_MNXT, KC_LBRC, KC_RBRC, _______, _______, _______, _______,
    /* └─────────────┴────────┴────────┴────────┴────────┴────────┴────────┘└────────┘     └────────┘└────────┴────────┴────────┴────────┴────────┴────────┴─────────────┘ */
    /*                                                             /────────/────────/      \────────\────────\   */
    /*                                  ┌────────┬──────────┐     /        /        /        \        \        \   ┌───────────┬────────┐ */
    /*                                  |        |          |    /        /        /          \        \        \  |           |        | */
